...
set_property PACKAGE_PIN L1 [get_ports {Product[7]}]
set_property PACKAGE_PIN P1 [get_ports {Product[6]}]
set_property PACKAGE_PIN N3 [get_ports {Product[5]}]
set_property PACKAGE_PIN P3 [get_ports {Product[4]}]
set_property PACKAGE_PIN U3 [get_ports {Product[3]}]
set_property PACKAGE_PIN W3 [get_ports {Product[2]}]
set_property PACKAGE_PIN V3 [get_ports {Product[1]}]
set_property PACKAGE_PIN V13 [get_ports {Product[0]}]
